...
This document describes the architecture of a 3-node Kubernetes homelab cluster running on 2 physical laptops. The cluster provides a self-hosted platform for running applications like  AdGuard Home (DNS/ad blocking) and other services.
...
| **Tunnel Name** | `balkandevops-tnl` |
| **Tunnel ID** | `d4d7f917-3152-4d10-aaf6-4b2e62743fc6` |

**Routes:**
| Domain | Backend |
|--------|---------|
| `elite.balkandevops.com` | Grafana |
...
- **Dashboards:** Grafana (`elite.balkandevops.com`)
